...
public class Division extends PositiveNegativeCounters implements BasicAction {
    ...
    private final static String EXAMPLE_DIVISION = "%d / %d = ";
    private final static String RIGHT_RESULT_DIVISION = "%d / %d = %d\n";
    private final static String WRONG_RESULT_DIVISION = "%d / %d = %d (%d)\n";
    ...
    public String formatEquation(int num1, int num2, int rightResult, int yourResult) {
        if (yourResult == rightResult) {
            return String.format(RIGHT_RESULT_DIVISION, num1, num2, rightResult);
        } else {
            return String.format(WRONG_RESULT_DIVISION, num1, num2, rightResult, yourResult);
        }
    }
    ...
    public void printActionWithNumbers(int num1, int num2) {
        System.out.print(String.format(EXAMPLE_DIVISION, num1, num2));
    }
}
